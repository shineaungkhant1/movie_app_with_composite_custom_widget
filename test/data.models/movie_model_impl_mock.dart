...
class MovieModelImplMock extends MovieModel{
  ...
  Stream<List<MovieVO>> getNowPlayingMoviesFromDatabase() {
    return Stream.value(getMockMoviesForTest().where((element)=> element?.isNowPlaying ?? false)
    .toList());
  }
  ...
  Stream<List<MovieVO>> getPopularMoviesFromDatabase() {
    return Stream.value(getMockMoviesForTest().where((element)=> element?.isPopular ?? false)
        .toList());
  }
  ...
  Stream<List<MovieVO>> getTopRatedMoviesFromDatabase() {
    return Stream.value(getMockMoviesForTest().where((element)=> element?.isTopRated ?? false)
        .toList());
  }
